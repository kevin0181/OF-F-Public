...
public enum ExceptionEnum {
    ...
    FAIL_PASSWORD(HttpServletResponse.SC_UNAUTHORIZED, "A0008", "fail login", "로그인 실패", "비밀번호가 일치하지 않습니다."),
    ...
    CAN_NOT_CHANGE_USER_INFO(HttpServletResponse.SC_UNAUTHORIZED, "A0008", "can not change user info", "사용자의 정보를 변경할 수 없습니다."),
    // --token--
